  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M4 8h16M4 16h16" />
      ...
      <ul className='gap-4 font-normal text-sm text-white hidden lg:flex relative'>
        ...
        <Link to="" className=' navLink py-5 flex items-center gap-2 px-4 group'>
          ...
          <ul id="dropdown" className='py-2 hidden group-hover:block left-0 absolute top-full bg-white border-yellow-500 border-2 text-black w-full'>
            <li className='py-2 text-center'>CSS</li>
            <li className='py-2 text-center'>CSS</li>
            <li className='py-2 text-center'>CSS</li>
